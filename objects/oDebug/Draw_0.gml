...
/// @DnDArgument : "caption" ""frames: ""
/// @DnDArgument : "var" "oPlayer.invicibility_frames > oPlayer.blink_delay"
draw_text(cx + cw - 256, cy + 248, string("frames: ") + string(oPlayer.invicibility_frames > oPlayer.blink_delay));
